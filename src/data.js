const PROJECTS = [
  {
    ...
    tags: ["Market Analysis", "Retention", "2026 Trend"],
    ...
    body: `
      ...
      <h3>주요 사례 분석</h3>
      <ul>
        <li><strong>Battlefield 6:</strong> 유저의 전술적 파괴 행위가 전장의 역사를 기록. (환경 통제권 부여)</li>
        <li><strong>GTA V (FiveM):</strong> 유저가 스스로 직업과 인생 서사를 창조하는 '창발적 플랫폼'화.</li>
      </ul>

      <h3>결론: LTV와 리텐션</h3>
      <p>LTV = ∑(ARPDAU × Retention). 고품질 서사는 유저의 이탈을 막는 가장 강력한 방어막입니다.</p>
    `
  },
  {
    id: 2,
    ...
    body: `
      ...
      <h3>BM과 서사의 결합</h3>
      <p>스킨은 단순 외형이 아니라 '정체성 소비'입니다. '별수호자' 스킨 라인이 성공한 이유는 유저에게 소속감과 수집 욕구를 자극하는 평행우주 서사를 제공했기 때문입니다.</p>
  ...
  },
  {
    ...
    tags: ["Psychology", "Monetization"],
    summary: "자율성과 불확실성을 활용한 뇌과학적 리텐션 설계. (현재 집필 중)",
    status: "WIP",
    image: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=800&q=80",
    body: "<p>현재 데이터 분석 및 집필 진행 중입니다.</p>"
  }
];
